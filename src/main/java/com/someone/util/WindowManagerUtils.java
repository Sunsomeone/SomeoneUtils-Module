...
public class WindowManagerUtils {
    private static final WindowManager windowManager = (WindowManager) GlobalContextUtil.getContext().getSystemService(Context.WINDOW_SERVICE);
    ...
    public static LayoutParams createLayoutParams() {
        return new WindowManagerUtils.LayoutParams();
    }
    ...
    public static void addWindowManagerListener(WindowManagerListener windowManagerListener) {
        WindowManagerUtils.windowManagerListener = windowManagerListener;
    }

    public static void removeWindowManagerListener() {
        WindowManagerUtils.windowManagerListener = null;
    }

    public interface WindowManagerListener {

        void onAddView(String tag, View view, WindowManager.LayoutParams params);

        void onUpdateViewLayout(View view, WindowManager.LayoutParams params);

        void onRemoveView(String tag);
    }
